		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				<c:forEach items="${pedidos}" var="pedido">
					<tr>
						<td scope="row">${pedido.numPedido}</td>
						<td>${pedido.dataPedido}</td>
						<td>${pedido.formaPgto}</td>
						<td>${pedido.valorPgto}</td>
						<td>${pedido.cpfPassageiro}</td>
						<td>
		                    <form action="/BrasilTour/pedidos?delete=${pedido.numPedido}" method="post">
